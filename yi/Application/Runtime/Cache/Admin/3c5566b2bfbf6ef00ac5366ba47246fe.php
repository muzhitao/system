...
<head>
    ...
    <link rel="stylesheet" href="/Public/plugin/style/global/css/login.css" type="text/css">
    <style>
            ...
            <ul>
                <form action="#" method="post" id="form">
                    ...
                    <li><span>验证码:</span><input type="text" id="input-c" name="code" style="color:#9dcc5a;width:60px;text-transform:uppercase;" class="textinput" value="code" />
                        <img id="checkcode" src="<?php echo U('Public/verify');?>?"/>
                    </li>
