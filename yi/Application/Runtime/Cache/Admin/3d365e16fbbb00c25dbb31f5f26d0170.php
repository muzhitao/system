...
<div class="div-user lr10">
    <h1>Hello, <font color="#4c95b6"><?php echo (session('username')); ?></font><h1>
        <span>所属角色: 超级管理员</span>
        <span>上次登录时间: <?php echo (session('logintime')); ?></span>
        <span>上次登录IP: <?php echo (session('loginip')); ?></span>
</div>
<div class="div-button">
    <div class="bk15"></div>
    <ul>
        <li><a  href="<?php echo G_MODULE_PATH; ?>/content/article_add"><img src="/Public/plugin/style/global/image/btn_60_60_t.png"><span>添加文章</span></a></li>
        <li><a href="<?php echo G_MODULE_PATH; ?>/content/goods_add"><img src="/Public/plugin/style/global/image/btn_60_60_g.png"><span>添加商品</span></a></li>
        <li><a href="<?php echo WEB_PATH; ?>/member/member/list"><img src="/Public/plugin/style/global/image/btn_60_60_m.png"><span>会员管理</span></a></li>
        <li><a href="<?php echo G_MODULE_PATH; ?>/setting/webcfg"><img src="/Public/plugin/style/global/image/btn_60_60_s.png"><span>系统设置</span></a></li>
        <li><a href="<?php echo G_WEB_PATH; ?>"><img src="/Public/plugin/style/global/image/btn_60_60_i.png"><span>网站首页</span></a></li>
    </ul>
</div>
...
<div style="overflow:hidden">
    ...
    <div class="div-system width30">
        ...
        <ul>
            ...
            <li style="border-bottom:none;"><i>ZEND支持: </i><?php echo $SysInfo['zend_version']; ?> </li>
    ...
    <div class="div-about width30">
        ...
        <div class="bk10"></div>
        <ul>
            <li><i>程序版本:</i><?php echo (THINK_VERSION); ?></li>
