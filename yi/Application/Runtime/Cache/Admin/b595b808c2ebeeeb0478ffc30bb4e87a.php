...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            index_url = "<?php echo U('Index/Tdefault');?>";
            $("#iframe_src").attr("src",index_url);
            R_label=$("#R_label");
...
<div id="header">
    ...
    <div class="header_case">
        欢迎您：<a href="javascript:;" title="<?php echo (session('username')); ?>"><?php echo (session('username')); ?> [超级管理员]</a>
        <a href="<?php echo U('Public/lougout');?>" title="退出">[退出]</a>
        <a href="<?php echo U('Index/index');?>" title="网站首页" target="_blank">网站首页</a>
        <a href="<?php echo U('Index/index');?>" title="地图">地图</a>
...
<div id="left">
    <ul class="left_date" id="setting">
        ...
        <li><a href="javascript:void(0);" src="<?php echo U('Admin/list');?>">管理员管理</a></li>
        <li><a href="javascript:void(0);" src="<?php echo U('Admin/add');?>">添加管理员</a></li>
...
<div id="right">
    <div class="right_top">
        ...
        <ul class="R_btn">
            ...
            <a href="javascript:;" onClick="btn_map('<?php echo U("Index/map");?>');" class="system_button"><span>后台地图</span></a>
        </ul>
    </div>
